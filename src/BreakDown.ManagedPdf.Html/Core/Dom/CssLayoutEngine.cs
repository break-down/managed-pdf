...
namespace BreakDown.ManagedPdf.Html.Core.Dom
{
    ...
    internal static class CssLayoutEngine
    {
        ...
        public static void MeasureImageSize(CssRectImage imageWord)
        {
            ...
            imageWord.Height += imageWord.OwnerBox.ActualBorderBottomWidth + imageWord.OwnerBox.ActualBorderTopWidth + imageWord.OwnerBox.ActualPaddingTop +
                                imageWord.OwnerBox.ActualPaddingBottom;
        }
        ...
        public static void CreateLineBoxes(RGraphics g, CssBox blockBox)
        {
            ...
            if (blockBox.Height != null && blockBox.Height != CssConstants.Auto && blockBox.Overflow == CssConstants.Hidden &&
        ...
        private static void FlowBox(RGraphics g,
                                    CssBox blockbox,
                                    CssBox box,
                                    double limitRight,
                                    double linespacing,
            ...
            if (box.Words.Count > 0)
            {
                ...
                if (words.Count > 0)
                {
                    foreach (var word in words)
                    {
                        ...
                        if (box == box.ParentBox.Boxes[0] && word == box.Words[0] && word == line.Words[0] && line != line.OwnerBox.LineBoxes[0] &&
                            !word.IsLineBreak)
                        {
