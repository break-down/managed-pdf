...
internal sealed class SelectionHandler : IDisposable
{
    ...
    /// <seealso cref="CalculateWordCharIndexAndOffset(BreakDown.ManagedPdf.Html.Adapters.RControl,BreakDown.ManagedPdf.Html.Core.Dom.CssRect,BreakDown.ManagedPdf.Html.Adapters.Entities.RPoint,bool)"/>.
    /// </summary>
    ...
    private static void CalculateWordCharIndexAndOffset(RControl control,
                                                        CssRect word,
                                                        RPoint loc,
                                                        bool inclusive,
