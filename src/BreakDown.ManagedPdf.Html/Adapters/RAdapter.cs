...
namespace BreakDown.ManagedPdf.Html.Adapters;
...
public abstract class RAdapter
{
    ...
    public RImage GetLoadingImage()
    {
        if (_loadImage == null)
        {
            var stream = typeof(HtmlRendererUtils).Assembly.GetManifestResourceStream("TheArtOfDev.BreakDown.ManagedPdf.Core.Html.Core.Utils.ImageLoad.png");
            if (stream != null)
            {
    ...
    public RImage GetLoadingFailedImage()
    {
        if (_errorImage == null)
        {
            var stream = typeof(HtmlRendererUtils).Assembly.GetManifestResourceStream("TheArtOfDev.BreakDown.ManagedPdf.Core.Html.Core.Utils.ImageError.png");
            if (stream != null)
            {
