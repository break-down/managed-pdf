...
using System;
using System.IO;
using BreakDown.ManagedPdf.Core.SharpZipLib.Checksums;

// ReSharper disable RedundantThisQualifier

//#if !NETCF_1_0
//using System.Security.Cryptography;
//using BreakDown.ManagedPdf.Core.SharpZipLib.Encryption;
//#endif
...
internal class DeflaterOutputStream : Stream
{
    ...
    protected void InitializePassword(string password)
    {
        ...
        var rawPassword = ZipConstants.ConvertToArray(password);
